...
describe('Cinema', function () {
  ...
  it('should be able to check whether there are no films from a particular year', function() {
    const actual = cinema.findByYear(2019);
    assert.strictEqual(actual, 'There are no films from this year.');
  });

  it('should be able to check whether all films are over a particular length - no', function() {
    const actual = cinema.allFilmsParticularLength(100);
    assert.strictEqual(actual, false);
  });

  it('should be able to check whether all films are over a particular length - yes', function() {
    const actual = cinema.allFilmsParticularLength(90);
